	...
	<div v-loading="loading">
		...
		<div class="mt10">
			<el-table border :height="300" :data="tableData">
				<el-table-column property="articleTitle" label="文章名称"></el-table-column>
				<el-table-column width="220" property="_id" label="文章ID"></el-table-column>
			</el-table>
		</div>
...
<script>
	...
	export default {
		...
		created(){
			this.$Bus.$off('showArticlePopover');
			this.$Bus.$on('showArticlePopover', this.pullData);
		}
	}
</script>
